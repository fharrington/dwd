...
<script type="text/javascript" src="/js/metalmixupsb.js"></script>
...
<div id = "wrap">
	...
	<audio preload="auto" title="sound7" id="audio7">
	<source src="audio/sound7.wav"></source>
	<source src="audio/sound7.ogg"></source>
	<source src="audio/sound7.mp3"></source>
	Browser!supportsound
	</audio>
	
	<audio preload="auto" title="sound8" id="audio8">
	<source src="audio/sound8.wav"></source>
	<source src="audio/sound8.ogg"></source>
	<source src="audio/sound8.mp3"></source>
	Browser!supportsound
	</audio>

	<audio preload="auto" title="sound9" id="audio9">
	<source src="audio/sound9.wav"></source>
	<source src="audio/sound9.ogg"></source>
	<source src="audio/sound9.mp3"></source>
	Browser!supportsound
	</audio>

	<audio preload="auto" title="sound10" id="audio10">
	<source src="audio/sound10.wav"></source>
	<source src="audio/sound10.ogg"></source>
